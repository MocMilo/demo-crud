package com.mocmilo.springdemo.services;

import com.mocmilo.springdemo.conf.AppConfig;
import com.mocmilo.springdemo.crud.model.RentalAgreement;
import com.mocmilo.springdemo.crud.model.RentalCar;
import com.mocmilo.springdemo.crud.model.RentalClient;
import com.mocmilo.springdemo.crud.repository.RentalAgreementCRUDService;
import com.mocmilo.springdemo.crud.repository.RentalCarCRUDService;
import com.mocmilo.springdemo.crud.repository.RentalClientCRUDService;
...
/*        if (rentalCar != null) {
    ...
    public void shouldDeleteRentalCarAndRentalClientAgreementRecordsInDatabase() {
        ...
        Optional<RentalCar> carFromDb = rentalCarCRUDService.findById(new Long("2"));

        carFromDb.ifPresent(rentalCar -> rentalCarCRUDService.delete(rentalCar));

        Optional<RentalCar> carFromDb2 = rentalCarCRUDService.findById(new Long("2"));
