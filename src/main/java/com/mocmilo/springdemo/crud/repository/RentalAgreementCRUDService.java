package com.mocmilo.springdemo.crud.repository;
...
@Repository
@Transactional
public class RentalAgreementCRUDService implements JpaRepository<RentalAgreement, Long> {
    ...
    @Override
    public Optional<RentalAgreement> findById(Long id) {
    ...
    @Override
    public List<RentalAgreement> findAllById(Iterable<Long> iterable) {
        return null;
    }
    ...
    @Override
    public RentalAgreement getOne(Long aLong) {
        return null;
    }
    ...
    public void deleteById(Long id) {
        ...
        if (agreement.isPresent()) {
            Long agreementId = agreement.get().getAgreementId();
