...
@Repository
@Transactional
public class RentalCarCRUDService implements JpaRepository<RentalCar, Long> {
    ...
    @Override
    public List<RentalCar> findAllById(Iterable<Long> iterable) {
        return null;
    }
    ...
    @Override
    public RentalCar getOne(Long aLong) {
        return null;
    }
