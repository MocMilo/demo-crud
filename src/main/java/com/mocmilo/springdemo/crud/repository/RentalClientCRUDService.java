...
@Repository
@Transactional
public class RentalClientCRUDService implements JpaRepository<RentalClient, Long> {

    @PersistenceContext
    private EntityManager em;

    @Override
    public Optional<RentalClient> findById(Long id) {
    ...
    @Override
    public List<RentalClient> findAllById(Iterable<Long> iterable) {
        return null;
    }
    ...
    @Override
    public RentalClient getOne(Long id) {
        return null;
    }
